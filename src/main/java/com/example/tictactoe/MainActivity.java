...
import static com.example.tictactoe.R.id.currentPlayerSymbol;
import static com.example.tictactoe.R.id.player1;
import static com.example.tictactoe.R.id.player2;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private ImageView mcurrentPlayerSymbol;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mnamePlayer1 = savedInstanceState.getString("P1");
        mnamePlayer2 = savedInstanceState.getString("P2");
        mcurrentPlayerSymbol = (ImageView) findViewById(currentPlayerSymbol);
        mcurrentPlayerSymbol.setBackgroundResource(R.drawable.dark_cross);
        mboard = (TableLayout) findViewById(R.id.table);
    ...
    public void displayBoard() {
        ...
        mplayer1 = (TextView) findViewById(player1);
        mplayer2 = (TextView) findViewById(player2);

        mplayer1.setText(mnamePlayer1);
        mplayer2.setText(mnamePlayer2);
        ...
        for(int rows = 0; rows < 9; rows++) {
            ...
            for(int col = 0; col < 9; col++) {
                ...
                mimage.setId(count++);
                mimage.setTag("DARK_CELL");
                mimage.setOnClickListener(this);
                mimage.setBackgroundResource(R.drawable.dark_cell);

                row.addView(mimage);

            }
            mboard.addView(row, new TableLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        }
    }
    ...
    private void playGame() {
        ...
        game.start(mnamePlayer1, mnamePlayer2);

        Toast.makeText(this, mnamePlayer1 + " to Play", Toast.LENGTH_SHORT).show();
    }
    ...
    private void changeCurrentPlayerSymbol() {
        if(game.getTurn() % 2 == 1) {
            mcurrentPlayerSymbol.setBackgroundResource(R.drawable.dark_cross);
        } else {
            mcurrentPlayerSymbol.setBackgroundResource(R.drawable.dark_zero);
        }
    }
    ...
    public void showResultPopupWindow() {
        ...
        if(game.getWinner().equals("DRAW")) tv.setText("DRAW !!!");
        else tv.setText(game.getWinner() + " WINS the game !!!");
